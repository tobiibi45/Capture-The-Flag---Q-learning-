...
namespace KStudio
{
	...
	void qlearning::train(int state)
	{
		initialize();
	...
	void qlearning::episode(int state)
	{
		currentState = state;
	...
	int qlearning::getRandomAction(int upperBound, int lowerBound)
	{
		int action = 0;
	...
	int qlearning::reward(int action)
	{
